...
/**
* square root function for usigned number
* source: http://www.microchip.com/forums/m577584.aspx
*/
...
int main(int argc, char *argv[]) {
    ...
    uint64_t std = SquareRoot(total_square_sum/total_cnt - total_mean_elapse_time*total_mean_elapse_time);
    printf("total drop number:  %d\n", total_drop_cnt);
    printf("mean elapse queueing time:  %" PRIu64 " (nsec)\n", total_mean_elapse_time);
    printf("approx. standard deviation of queueing time:  %" PRIu64 " (cycles)\n", std);
